<?php
include "header.php";
$sql=mysqli_query($con,"select * from volunteer");
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                <li><a href="view_facility.php">Volunteer</a> <span class="bread-slash">/</span></li>
                                <li><span class="bread-blod">View volunteers</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap">
                    <?php
                    $sq=mysqli_query($con,"select * from login WHERE type='volunteer' and status='pending'");
                                        ...
                                        <div class="sparkline13-graph">
                                            <div class="datatable-dashv1-list custom-datatable-overright">
                                                <table id="table" data-toggle="table" data-pagination="true"
                                                    ...
                                                    <?php
                                                    $i = 1;
                                                    $view = mysqli_query($con, "select *from volunteer inner join login on volunteer.mobile=login.uname where login.status='pending'");
                                                    while ($row = mysqli_fetch_array($view)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="approve_volunteer.php?volid=<?php echo $row['mobile'] ?>"
                                    ...
                                    <div class="sparkline13-graph">
                                        <div class="datatable-dashv1-list custom-datatable-overright">
                                            <table id="table" data-toggle="table" data-pagination="true"
                                                ...
                                                <?php
                                                $i = 1;
                                                $view = mysqli_query($con, "select *from volunteer inner join login on volunteer.mobile=login.uname where login.status='approved'");
                                                while ($row = mysqli_fetch_array($view)) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $i ?></td>
                                                        ...
                                                        <td>
                                                            <a href="disable_volunteer.php?volid=<?php echo $row['mobile'] ?>"
                                                               data-toggle="tooltip" title="Edit" class="pd-setting-ed"><img src="img/delet.png"
                                                                                                                             style="height: 30px;width: 35px;"></a>
                                                        </td>
