...
public class EquipmentHomeActvity extends AppCompatActivity {
    TextView tv_av_equip,tv_cur_equip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_cur_equip=(TextView)findViewById(R.id.tv_cur_equip);
        ...
        tv_cur_equip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent regIntent = new Intent(EquipmentHomeActvity.this,CurrentEquipActivity.class);
                startActivity(regIntent);
